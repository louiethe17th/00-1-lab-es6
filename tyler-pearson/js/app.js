...
function displayPics(){
  ...
  // the var rando does not work when changed to let because let is a block scope local variable and the next while loop cannot access  it because it is a different block 
  console.log(viewed);
